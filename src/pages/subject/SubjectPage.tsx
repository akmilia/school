...
import { useEffect, useState, useContext } from "react";
import { getSubjects, getTypes, enrollToSubject, getGroups } from "../../api/subjects";
import HeaderAdmin from "../../components/HeaderAdmin/Header";
import './SubjectPage.css';
import { Button, Table, Form, Badge, Spinner, Alert } from "react-bootstrap";
import { AuthContext } from "../../context/AuthContext";
...
export const SubjectPage = () => { 
    ...
    const [groupSortField, setGroupSortField] = useState('idgroups');
    ...
    const handleEnrollGroup = async (groupId: number) => {
        // try {
        //   // Реализуйте запрос на запись в группу
                      ...
                      filteredGroups.map((group) => (
                        <tr key={group.idgroups}>
                          ...
                          <td>
                            <Button
                              variant="primary"
                              onClick={() => handleEnrollGroup(group.idgroups)}
                            >
                              Записаться
                            </Button>
                          </td>
