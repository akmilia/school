    ...
    return (
        <header className={cl.header_wrapper}>
            <div className={cl.header}>
                ...
                <nav className={cl.nav}>
                    <ul className={cl.nav_list}>
                        <li><Link to="/schedule" className={cl.nav_link}>Расписание</Link></li>
                        <li><Link to="/subjects" className={cl.nav_link}>Занятия</Link></li>
                        <li><Link to="/users" className={cl.nav_link}>Преподаватели</Link></li>
                    </ul>
                </nav>
                
                <div className={cl.header_right}>
                    <button className={cl.notification_btn}>
                        <img src={Bell} alt="Уведомления" className={cl.icon} />
                    </button>
                    <button 
                        className={cl.profile_btn}
                        onClick={() => navigate('/profile')}
                    >
